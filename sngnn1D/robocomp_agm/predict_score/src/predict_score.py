...
# \mainpage RoboComp::predict_score
#
...
#
# Just: "${PATH_TO_BINARY}/predict_score --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	if status == 0:
		...
		app.installEventFilter(worker)
		print("Installed Event filter")
